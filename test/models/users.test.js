...
describe('Users', () => {
  ...
  describe('add', () => {
    it('should add new user', () => {
      ...
      expect(users.list).toContainEqual({
        fakeName: 'unicorn42',
        realName: 'Seb',
        id: '1',
        discovered: false,
  ...
  describe('getAllRealNames', () => {
    it('should return all the real names of users', () => {
      ...
      expect(users.getAllRealNames()).toEqual(
        expect.arrayContaining(['seb1', 'seb2', 'seb3'])
      );
    });
  });
  ...
  describe('getAllFakeNames', () => {
    it('should return all the fake names of users', () => {
      ...
      users.add('unicorn2', 'seb2');
      users.add('unicorn3', 'seb3');
      expect(users.getAllFakeNames()).toEqual(
        expect.arrayContaining(['unicorn1', 'unicorn2', 'unicorn3'])
      );
    });
  });
